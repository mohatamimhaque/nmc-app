...
const migrationPath = resolve(process.cwd(), 'supabase/migrations/027_add_volunteer_management.sql')
...
console.log(`Executing volunteer management migration (${statements.length} statements)...`)
...
console.log('Volunteer management migration executed successfully!')
