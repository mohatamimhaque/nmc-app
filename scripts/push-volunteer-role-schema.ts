...
const migrationPath = resolve(process.cwd(), 'supabase/migrations/028_add_volunteer_role.sql')
...
console.log(`Executing volunteer role migration (${statements.length} statements)...`)
...
console.log('Volunteer role migration executed successfully!')
