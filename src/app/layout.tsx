...
const fallbackMetadata = {
  ...
  description:
    'Official website of the National Mathematics Carnival 2026, organised by Math Club, Dhaka University of Engineering & Technology (DUET).',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Official website of the National Mathematics Carnival 2026, organised by Math Club, DUET.',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'National Mathematics Carnival 2026',
    description: 'Official website of NMC 2026 — Math Club, DUET.',
  },
  robots: {
    index: true,
    follow: true,
